...
- [`bdpe_get_token()`](https://monitoramento.sepe.pe.gov.br/bigdatape/reference/bdpe_get_token.md)
  : Retrieve the token associated with a specific dataset
- [`bdpe_list_tokens()`](https://monitoramento.sepe.pe.gov.br/bigdatape/reference/bdpe_list_tokens.md)
  : List all datasets that have stored tokens in environment variables
- [`bdpe_remove_token()`](https://monitoramento.sepe.pe.gov.br/bigdatape/reference/bdpe_remove_token.md)
  : Remove the token associated with a specific dataset
- [`bdpe_store_token()`](https://monitoramento.sepe.pe.gov.br/bigdatape/reference/bdpe_store_token.md)
  : Store a token in an environment variable for a specific dataset
- [`parse_queries()`](https://monitoramento.sepe.pe.gov.br/bigdatape/reference/parse_queries.md)
